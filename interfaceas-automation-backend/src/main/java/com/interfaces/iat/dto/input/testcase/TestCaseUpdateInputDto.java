...
@ApiModel(value = "测试用例修输入DTO",description = "描述测试用例件信息")
@Data
public class TestCaseUpdateInputDto {
    @ApiModelProperty(value = "测试用例ID",position = 1,example = "99")
    ...
    @ApiModelProperty(value = "所属项目ID",position = 13,example = "99")
