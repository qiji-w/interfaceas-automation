  ...
  <div class="job-edit">
    <el-form :model="job"
      ...
      <el-form-item label="项目环境"
                    label-width="120px">
        <el-select v-model="job.environmentId"
                   placeholder="请选择项目环境"
                   style="width: 100%">
    ...
    <el-row :gutter="20">
      <el-col :span="14">
        ...
        <div style="font-size: 12px; line-height: 16px">
          * * * * * * *
          <span style="color: #909399">分别表示：秒 分钟 小时 日期 月份 星期 年(可选)
          </span>
        </div>
        <div style="font-size: 12px; line-height: 16px">
          秒：
          <span style="color: #909399">可以是从0到59之间的任何整数。</span>
        </div>
        <div style="font-size: 12px; line-height: 16px">
          分钟：
          <span style="color: #909399">可以是从0到59之间的任何整数。</span>
        ...
        <div style="font-size: 12px; line-height: 16px">
          小时：<span style="color: #909399">可以是从0到23之间的任何整数。</span>
        </div>
        <div style="font-size: 12px; line-height: 16px">
          日期：<span style="color: #909399">可以是从1到31之间的任何整数。</span>
        </div>
        <div style="font-size: 12px; line-height: 16px">
          月份：<span style="color: #909399">可以是从1到12之间的任何整数。</span>
        </div>
        <div style="font-size: 12px; line-height: 16px">
          星期：<span style="color: #909399">可以是从1到7之间的任何整数，1代表星期日。</span>
        </div>
        <div style="font-size: 12px; line-height: 16px">
          年份(可选)：<span style="color: #909399">正常年份即可。</span>
        </div>
      </el-col>
      <el-col :span="10">
        <h5>配置案例：</h5>
