  ...
  <div class="task-run">
    <el-form :model="task"
      ...
      <el-form-item label="项目环境">
        <el-select v-model="taskRun.environmentId"
                   placeholder="请选择项目环境"
                   style="width: 100%;">
      ...
      <el-form-item label="运行记录名称">
        <el-input v-model="taskRun.name"
                  placeholder="请输入运行记录名称"></el-input>
      </el-form-item>
      <el-form-item label="描述">
        <el-input v-model="taskRun.description"
    ...
    <div slot="footer"
      ...
      <el-button type="success"
                 plain
                 @click="run"
                 icon="el-icon-caret-right">运 行</el-button>
    </div>
  </div>
</template>
