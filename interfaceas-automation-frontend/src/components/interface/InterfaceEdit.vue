  ...
  <div class="interface-edit">
    <el-form :model="int"
      ...
      <el-form-item prop="module"
                    label="所属模块">
        <el-select v-model="int.moduleId"
                   placeholder="请选择所属模块"
                   style="width: 100%;">
      ...
      <el-form-item prop="name"
                    label="接口名称">
        <el-input v-model.trim="int.name"
                  placeholder="请输入接口名称"></el-input>
      </el-form-item>
      <el-form-item prop="path"
                    label="接口地址">
        <el-input v-model.trim="int.path"
                  autocomplete="off"
                  placeholder="请输入接口地址，输入不包含域名的相对路径，如/account/login"></el-input>
      </el-form-item>
      <el-form-item prop="requestMethod"
                    label="请求方法">
        <el-select v-model="int.requestMethod"
                   placeholder="请选择请求方法"
                   style="width: 100%;">
          <el-option v-for="item in requestMethods"
                     :key="item"
                     :label="item"
                     :value="item">
          </el-option>
      ...
      <el-form-item prop="responseType"
                    label="响应类型">
        <el-select v-model="int.responseType"
                   placeholder="请选择响应类型"
                   style="width: 100%;">
          <el-option v-for="item in responseTypes"
                     :key="item"
                     :label="item"
                     :value="item">
          </el-option>
