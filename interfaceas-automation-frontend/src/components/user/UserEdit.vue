    ...
    <el-form ref="user"
      ...
      <el-form-item label="用户名">
        <el-input v-model="user.username"
                  placeholder="用输入用户名"></el-input>
      </el-form-item>
      <el-form-item label="密码"
                    style="text-align: left">
        <el-input v-model="user.password"
                  placeholder="用输入密码"
                  v-if="!user.id"></el-input>
        <el-button type="primary"
                   @click="isShowReset = true"
                   v-if="id && !isShowReset">重置密码</el-button>
        <el-input v-model="resetPassword"
                  placeholder="用输入密码"
                  v-if="isShowReset"></el-input>
        <el-button type="primary"
                   @click="reset"
                   v-if="isShowReset">确定</el-button>
        <el-button @click="isShowReset = false"
                   v-if="isShowReset">取消</el-button>
      </el-form-item>
      <el-form-item label="姓名">
        <el-input v-model="user.name"
                  placeholder="用输入姓名"></el-input>
      </el-form-item>
      <el-form-item label="邮箱">
        <el-input v-model="user.email"
                  placeholder="用输入邮箱"></el-input>
      </el-form-item>
      <el-form-item label="电话">
        <el-input v-model="user.mobile"
                  placeholder="用输入电话"></el-input>
      </el-form-item>
